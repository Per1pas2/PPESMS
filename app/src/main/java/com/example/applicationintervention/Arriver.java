...
public class Arriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView heure = findViewById(R.id.TXT_HEURE2);

        Button bouton_envoi_sms = findViewById(R.id.BTN_ENVOIE_SMS);
        Spinner spinner = findViewById(R.id.SPN_LOGEMENT);
        ...
        Spinner spinnerintervention = findViewById(R.id.SPN_Type_Intervention);
        ...
        bouton_envoi_sms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String textesms = "?text=Arrivée Localisation : "+ spinner.getSelectedItem().toString() + ",Intervention : "+spinnerintervention.getSelectedItem().toString()+",Entreprise : "+ entreprise.getText().toString()+ ",Heure : "+heure.getText().toString();
